...
export default function HeroSection() {
  return (
    <section className="w-full px-4 pt-4 pb-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-0 overflow-visible md:flex-row md:items-center lg:py-8">
        <div className="w-full md:w-1/2 md:pr-2 lg:pr-4">
          <div className="flex flex-col text-left">
            <h1 className="mb-4 max-w-[400px] text-5xl font-bold leading-[1.1] text-[#3d362f] sm:text-6xl lg:text-7xl">
              Casual Talk
              <br />
              with your
              <br />
            ...
            <p className="mt-3 text-xl text-[#3d362f]/80">
              convert your voice into text
            </p>
            <div className="mt-8">
              <button
                type="button"
                className="rounded-full bg-[#e07b2d] px-6 py-3 text-lg font-semibold text-white shadow-md hover:opacity-90"
              >
                Get Started
              </button>
            </div>
